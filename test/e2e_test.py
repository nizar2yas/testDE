...
from src.pipeline import MentionsExtractor, CombinerFn, CustomPipelineOptions
import json
import os
...
class TestPipeline(unittest.TestCase):
    ...
    #     pipeline_options = CustomPipelineOptions(['--data_folder_path', test_data_dir, '--output_folder_path', test_output_dir])
    ...
    def test_mentionsextractor(self):
        with TestPipeline() as p:
            ...
            input_data = '1,"Clinical trial of drug_a",2023-10-26,Journal A'  # Use double quotes as in real data
            expected_output = [("drug_a", {'clinical_trials': {'title': 'Clinical trial of drug_a', 'date': '2023-10-26', 'journal': 'Journal A'}})]  # Correct expected output format
            ...
            beam.assert_that(results, beam.equal_to(expected_output))

    #Existing test_combinerfn
